...
(function () {
    ...
    /* --- INTERACTIVE CONTACT FORM --- (Handled natively by script.js VANTA Deal Desk) */
    function initInteractiveContactForm() {
        // Handled centrally in script.js to avoid duplicate submissions
        console.log("[VANTA] Contact form managed by Deal Desk Core");
    }
