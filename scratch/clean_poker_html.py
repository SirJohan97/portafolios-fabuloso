...
html_content = """        <!-- Real 3D Rounded Poker Table Section -->
        <div class="poker-pinned-wrapper">
            <div class="poker-header">
                <span class="hud-label">// VANTA_ENGINEERING_POKER_DECK.SYS</span>
                <h2 class="section-title"><span class="reveal-word">Arquitectura</span> <span class="reveal-word">&amp;</span> <span class="reveal-word">Capacidades</span></h2>
                <p class="section-subtitle">Mazo de cartas tecnológicas de élite en mesa de póker Heads-Up (Andrés vs. Johan).</p>
            </div>

            <!-- Real 3D Rounded Poker Table Container -->
            <div class="poker-table-container">
                <div class="poker-table-felt" id="poker-table-felt">
                    ...
                    <!-- Top Player Seat: ANDRÉS (Top Rail) -->
                    ...
                    <!-- Bottom Player Seat: JOHAN (Bottom Rail) -->
...
# Replace everything from <canvas id="poker-felt-canvas"... to <!-- Fullscreen Glass Modal...
idx_start = content.find('<canvas id="poker-felt-canvas"')
if idx_start == -1:
    idx_start = content.find('<div class="poker-pinned-wrapper">')
...
if idx_start != -1 and idx_end != -1:
    ...
    with open('index.html', 'w', encoding='utf-8') as f:
        f.write(new_content)
    print('SUCCESS: Updated index.html cleanly!')
else:
    print(f'ERROR: Could not locate markers in index.html. idx_start={idx_start}, idx_end={idx_end}')
