...
document.addEventListener('DOMContentLoaded', () => {
    ...
    // Efecto Magnético Global para Botones
    document.querySelectorAll('.btn, .btn-outline, .nav-links a').forEach(item => {
    ...
    const PROJECT_DATA = {
        ...
        inventario: {
            ...
            url: '#contact',
            gallery: [
                { type: 'image', src: 'img/inventario/WhatsApp Image 2026-04-16 at 3.24.24 PM.jpeg', label: 'Vista General del Sistema' },
                { type: 'image', src: 'img/inventario/WhatsApp Image 2026-04-16 at 3.24.24 PM (1).jpeg', label: 'Dashboard de Control' },
                { type: 'image', src: 'img/inventario/WhatsApp Image 2026-04-16 at 3.24.24 PM (2).jpeg', label: 'Gestión de Productos' },
                { type: 'image', src: 'img/inventario/WhatsApp Image 2026-04-16 at 3.24.24 PM (3).jpeg', label: 'Reportes y Estadísticas' },
                { type: 'image', src: 'img/inventario/WhatsApp Image 2026-04-16 at 3.24.24 PM (4).jpeg', label: 'Interfaz de Usuario Adaptable' },
                { type: 'image', src: 'img/inventario/WhatsApp Image 2026-04-16 at 3.24.24 PM (5).jpeg', label: 'Control de Entradas y Salidas' },
                { type: 'image', src: 'img/inventario/WhatsApp Image 2026-04-16 at 3.24.24 PM (6).jpeg', label: 'Módulo de Proveedores' },
                { type: 'image', src: 'img/inventario/WhatsApp Image 2026-04-16 at 3.24.24 PM (7).jpeg', label: 'Configuración Avanzada' },
                { type: 'image', src: 'img/inventario/WhatsApp Image 2026-04-16 at 3.24.24 PM (8).jpeg', label: 'Compatibilidad con Dispositivos' },
                { type: 'image', src: 'img/inventario/WhatsApp Image 2026-04-16 at 3.24.24 PM (9).jpeg', label: 'Respaldo de Información' }
            ]
        }
    };
        ...
        items.forEach((item, i) => {
            ...
            if (item.type === 'video') {
                ...
                media.addEventListener('click', () => {
                    if (typeof openFullscreen === 'function') openFullscreen(item.src);
                });
            }
